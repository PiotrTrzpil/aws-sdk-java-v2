...
public class RegionValidationUtilTest {
    ...
    public void fipsUsWest2_AwsPartition_IsNotValidRegion() {
        assertFalse(RegionValidationUtil.validRegion("fips-us-west-2", AWS_PARTITION_REGEX));
    }
    ...
    public void fipsUsGovWest1_AwsGovPartition_IsNotValidRegion() {
        assertFalse(RegionValidationUtil.validRegion("fips-us-gov-west-1", AWS_GOV_PARTITION_REGEX));
    }
